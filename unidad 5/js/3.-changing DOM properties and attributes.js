...
imagen.setAttribute("data-derechos_de_autor", "no");
console.log(imagen.data-derechos_de_autor);  //it doesn't work. derechos_de_autora is a attribute, not a property
console.log(imagen.getAttribute("data-derechos_de_autor"));  //it works
...
const elemento = document.querySelector('#clases>p');
